...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/sarkit-convert-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sarkit-convert-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sarkit-convert
# for installing globally
pixi global install sarkit-convert
```
...
It is possible to list all of the versions of `sarkit-convert` available on your platform:
...
```
pixi search sarkit-convert --channel conda-forge
```
